...
(
    ...
    `password`          varchar(200)            NOT NULL collate utf8mb4_general_ci NOT NULL,
...
(
    ...
    `favorite_count`    integer                 NOT NULL DEFAULT 0 COMMENT '',
    `comment_count`     INTEGER                 NOT NULL DEFAULT 0 COMMENT '',
